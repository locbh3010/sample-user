...
export const ProductItem = React.memo(({ data }) => {
  ...
  return (
    <Tooltip tip={data.name}>
      <div className="w-full h-auto flex flex-col cursor-pointer group border border-gray-300 relative rounded-lg">
        <div
          className="rounded-lg overflow-hidden mb-6 aspect-square flex-shrink-0 relative rounded-b-none bg-gray-200"
